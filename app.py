...
def main():
    ...
    symboling = left.number_input('Symboling', step=1.0, format='%.1f', value=-1)
    ...
    curbweight  = right.number_input('curbweight',  step=1.0, format='%.1f', value=3157)
    ...
    enginesize = left.number_input('enginesize',  step=1.0, format='%.1f', value=130)
    ...
    horsepower = right.number_input('horsepower',  step=1.0, format='%.1f', value=162)
    peakrpm = left.number_input('peakrpm',  step=1.0, format='%.1f', value=5100)
    citympg = right.number_input('citympg',  step=1.0, format='%.1f', value=17)
    highwaympg = left.number_input('highwaympg',  step=1.0, format='%.1f', value=22)
